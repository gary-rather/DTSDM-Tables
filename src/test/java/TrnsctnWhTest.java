...
public class TrnsctnWhTest extends TableTest {
    ...
    public void test01() {
        ...
        String sql = "Select count(*) from TRNSCTN_WH  where TRNSCTN_WID = 0 \n";
        ...
        System.out.println("Test TrnsctnWhTest  Row 0 = " + number);
    ...
    public void test02() {
        ...
        String sql1 = "select count(*) from \n" +
                "(\n" +
                "select distinct ACCNT_LBL, SRC_PM_DOC_ID, count (*)\n" +
                "from TRNSCTN_WH \n" +
                "group by ACCNT_LBL, SRC_PM_DOC_ID\n" +
                "having count(*) > 1\n" +
                ")";
        ...
        System.out.println("Test TrnsctnWhTest  dupeCount= " + dupeCount);
