...
public class PersonAccntAuditWhTest extends TableTest {
    ...
    public  static void openResults(){
        wr = new WriteResults("PersonAccntAuditWhTest.html");
        wr.pageHeader();
    }
    ...
    public void test01() {
        ...
        String sql = "Select count(*) from DTSDM.PERSON_ACCNT_AUDIT_WH  where PERSON_ACCNT_AUDIT_WH.PERSON_ACCNT_AUDIT_WID = 0 \n";
        ...
        System.out.println("Test PersonAccntAuditWhTest  Row 0 = " + number);
    ...
    public void test02() {
        ...
        System.out.println("Test PersonAccntAuditWhTest  dupeCount= " + dupeCount);
