...
public class DcmntFactTest extends TableTest {

    @BeforeClass
    public  static void openResults(){
        wr = new WriteResults("DcmntFactTest.html");
        wr.pageHeader();
    }
    ...
    public void test01() {
        ...
        String sql1 = "select count(*) from \n" +
                "(\n" +
                "select distinct  DCMNT_WID, count(*)\n" +
                "from DTSDM_BI.DCMNT_FACT\n" +
                "group by DCMNT_WID \n" +
                "having count(*) > 1\n" +
                ")";
        ...
        System.out.println("Test DcmntFactTest  dupeCount= " + dupeCount);
