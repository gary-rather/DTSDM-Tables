...
public class PersonAddrWhTest extends TableTest {
    ...
    public void test01() {
        ...
        String reason = " Initial load must add  unspecified data row.  Provides the ability to traverse through the DTSDM.PERSON_ADDR_WH table when no value is matched";
    ...
    public void test02() {
        // Log the Class and method
        System.out.println("Starting " + this.getClass().getSimpleName() + " " + new Throwable().getStackTrace()[0].getMethodName());
        String condition = " Check the population of the PERSON_ADDR_WH. PERSON_ADDR_WID (PK) column";
