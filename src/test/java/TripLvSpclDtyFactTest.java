...
public class TripLvSpclDtyFactTest extends TableTest {

    @BeforeClass
    public  static void openResults(){
        wr = new WriteResults("TripLvSpclDtyFactTest.html");
        wr.pageHeader();
    }
    ...
    public void test01() {
        ...
        String sql1 = "select count(*) from \n" +
                "(\n" +
                "select distinct FACT_TYPE_WID, TRIP_LEAVE_WID, LEG_SPCL_DUTY_WID, count(*)\n" +
                "from DTSDM_BI.TRIP_LV_SPCL_DTY_FACT\n" +
                "group by FACT_TYPE_WID, TRIP_LEAVE_WID, LEG_SPCL_DUTY_WID \n" +
                "having count(*) > 1\n" +
                ")";
        ...
        System.out.println("Test TripLvSpclDtyFactTest  dupeCount= " + dupeCount);
