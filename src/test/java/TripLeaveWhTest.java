...
public class TripLeaveWhTest extends TableTest {
    ...
    public void test01() {
        ...
        String sql = "Select count(*) from TRIP_LEAVE_WH  where TRIP_LEAVE_WID = 0 \n";
        ...
        System.out.println("Test TripLeaveWhTest  Row 0 = " + number);
    ...
    public void test02() {
        ...
        String sql1 = "select count(*) from \n" +
                "(\n" +
                "select distinct TRIP_LEG_WID, count (*)\n" +
                "from TRIP_LEAVE_WH\n" +
                "group by TRIP_LEG_WID\n" +
                "having count(*) > 1\n" +
                ")";
        ...
        System.out.println("Test TripLeaveWhTest  dupeCount= " + dupeCount);
