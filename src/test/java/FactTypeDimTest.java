...
public class FactTypeDimTest extends TableTest {

    @BeforeClass
    public  static void openResults(){
        wr = new WriteResults("FactTypeDimTest.html");
        wr.pageHeader();
    }
    ...
    public void test02() {
        ...
        String sql1 = "select count(*) from \n" +
                "(\n" +
                "select distinct  FACT_TYPE_WID, count(*)\n" +
                "from DTSDM_BI.FACT_TYPE_DIM\n" +
                "group by FACT_TYPE_WID \n" +
                "having count(*) > 1" +
                ")";
        ...
        System.out.println("Test FactTypeDimTest  dupeCount= " + dupeCount);
