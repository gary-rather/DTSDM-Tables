...
public class StateCountryRfrncWhTest extends TableTest {
    ...
    public void test3() {
        ...
        // Log the results before
        ArrayList<ResultObject> roList = new ArrayList<ResultObject>();
        ResultObject ro1 = new ResultObject((302 == destCount), "(302 == destCount)");
        roList.add(ro1);
        ResultObject ro2 = new ResultObject((301 == srcCount), "(301 == srcCount)");
        roList.add(ro2);
    ...
    public void test5() {
		...
		// Log the results before
		ArrayList<ResultObject> roList = new ArrayList<ResultObject>();
		ResultObject ro1 = new ResultObject((1 == minusCount), "(2 == minusCount)");
		roList.add(ro1);
		wr.logTestResults(roList);
    ...
    public void test6() {
		...
		// Log the results before
		ArrayList<ResultObject> roList = new ArrayList<ResultObject>();
		ResultObject ro1 = new ResultObject((302 == tableRowsCount), "(302 == tableRowsCount)");
		roList.add(ro1);
		wr.logTestResults(roList);
