...
public class PersonAuditWhTest extends TableTest {

    @BeforeClass
    public  static void openResults(){
        wr = new WriteResults("PersonAuditWhTest.html");
        wr.pageHeader();
    }
    ...
    public void test01() {
        ...
        String sql = "Select count(*) from  PERSON_AUDIT_WH  where PERSON_AUDIT_WID = 0 ";
        ...
        System.out.println("Test PersonAuditWhTest  Row 0 = " + number);
    ...
    public void test02() {
        ...
        System.out.println("Test PersonAuditWhTest  dupeCount= " + dupeCount);
