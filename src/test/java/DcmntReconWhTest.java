...
public class DcmntReconWhTest extends TableTest {

    @BeforeClass
    public  static void openResults(){
        wr = new WriteResults("DcmntReconWhTest.html");
        wr.pageHeader();
    }
    ...
    public void test01() {
        ...
        String sql = "Select count(*) from DTSDM. DCMNT_RECON_WH  where DCMNT_RECON_WID = 0 \n";
        ...
        System.out.println("Test DcmntReconWhTest  Row 0 = " + number);
    ...
    public void test02() {
        ...
        System.out.println("Test DcmntReconWhTest  dupeCount= " + dupeCount);
