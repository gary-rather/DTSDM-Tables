...
public class TicketFactTest extends TableTest {
    ...
    public void test01() {
        ...
        String sql1 = "select count(*) from \n" +
                "(\n" +
                "select distinct  TICKET_WID, count(*)\n" +
                "from DTSDM_BI.TICKET_FACT\n" +
                "group by TICKET_WID \n" +
                "having count(*) > 1" +
                ")";
        ...
        System.out.println("Test TicketFactTest  dupeCount= " + dupeCount);
