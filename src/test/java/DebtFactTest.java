...
public class DebtFactTest extends TableTest {

    @BeforeClass
    public  static void openResults(){
        wr = new WriteResults("DebtFactTest.html");
        wr.pageHeader();
    }
    ...
    public void test02() {
        ...
        String sql1 = "select count(*) from \n" +
                "(\n" +
                "select distinct  DEBT_FACT_WID, count(*)\n" +
                "from DTSDM_BI.DEBT_FACT\n" +
                "group by DEBT_FACT_WID \n" +
                "having count(*) > 1" +
                ")";
        ...
        System.out.println("Test DebtFactTest  dupeCount= " + dupeCount);
